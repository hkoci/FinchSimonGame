 ...
 */
public class GamePlayPhysicalFinch5 extends Application {
    ...
    private Finch finchObject2 = new Finch();
    private Finch finchObject3 = new Finch();
    private Finch finchObject4 = new Finch();
    private Finch finchObjectToggle = new Finch();
                ...
                Timeline gameLoopTimeline = new Timeline(new KeyFrame(Duration.seconds(1), new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        if(gameFinchToggle){
                            ...
                            //If toggle finch is tapped, make game state off.
                            if(finchObjectToggle.isTapped()){
                            ...
                            if(!gamePatternChecking){
                                ...
                                pauseColourChange.setOnFinished((ActionEvent event1) -> {
                                    ...
                                    finchObject2.setLED(Color.BLACK);
                                    finchObject3.setLED(Color.BLACK);
                                    finchObject4.setLED(Color.BLACK);
                                });
                                ...
                                switch (ColourSequenceRandomised.get(gameStatClass.getRound() - 1)) {
                                    ...
                                    case 2:
                                        ...
                                        //set finch colour
                                        finchObject2.setLED(finch2Colour);
                                    ...
                                    case 3:
                                        ...
                                        //set finch colour
                                        finchObject3.setLED(finch3Colour);
                                                ...
                                                if (finch1Tapped == true || finchObject1.isTapped()) {
                                                    ...
                                                    if (ColourSequenceRandomised.get(indexChar) == 1) {
                                                        ...
                                                        if (gameStatClass.getLives() > 0) {
                                                            ...
                                                            finchObject2.setLED(Color.RED,1000);
                                                            finchObject3.setLED(Color.RED,1000);
                                                            finchObject4.setLED(Color.RED,1000);
                                                        } else {
                                                    ...
                                                    if (ColourSequenceRandomised.get(indexChar) == 2) {
                                                        indexChar++;
                                                        finchObject2.setLED(finch2Colour,100);
                                                    } else {
                                                        //This finch was not tapped correctly, so we will reduce a live
                                                        //If they have had no lives then the game ends for them unfortunately
                                                        if (gameStatClass.getLives() > 0) {
                                                    ...
                                                    if (ColourSequenceRandomised.get(indexChar) == 3) {
                                                        indexChar++;
                                                        finchObject3.setLED(finch3Colour,100);
                                                    } else {
                                                        if (gameStatClass.getLives() > 0) {
                                                        //This finch was not tapped correctly, so we will reduce a live
                                                        //If they have had no lives then the game ends for them unfortunately
                                                    ...
                                                    if (ColourSequenceRandomised.get(indexChar) == 4) {
                                                        indexChar++;
                                                        finchObject4.setLED(finch4Colour,100);
                                                    } else {
                                                        //This finch was not tapped correctly, so we will reduce a live
                                                        //If they have had no lives then the game ends for them unfortunately
                                                        if (gameStatClass.getLives() > 0) {
